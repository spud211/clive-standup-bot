...
export const config = {
  ...
  piperLengthScale: parseFloat(process.env.PIPER_LENGTH_SCALE ?? "0.85"),
  piperNoiseScale: parseFloat(process.env.PIPER_NOISE_SCALE ?? "0.8"),
  piperNoiseWScale: parseFloat(process.env.PIPER_NOISE_W_SCALE ?? "1.0"),
