...
const helpText: Record<Language, string> = {
  en: [
    "📋 **Available Commands:** (use ! prefix, e.g. !start)",
    "**!start** — start the daily standup",
    ...
    "**!poll results / !poll close** — show or close poll",
  ...
  fr: [
    "📋 **Commandes disponibles :** (utilisez le préfixe !, ex: !start)",
    "**!start** — lancer le standup",
    ...
    "**!poll results / !poll close** — résultats ou fermer le sondage",
